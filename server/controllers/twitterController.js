...
let home = (req, res) => {
  oauth.get('https://api.twitter.com/1.1/statuses/home_timeline.json?count=5',
...
let seeTimeline = (req, res) => {
  oauth.get('https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=metamorphega&count=3', //bisa pakai ini, bisa juga pakai yang di bawah, count 2 = status 2 teratas
